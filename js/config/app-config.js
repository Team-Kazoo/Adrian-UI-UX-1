...
const DEFAULT_CONFIG = {
  ...
  pitchDetector: {
    ...
    minVolumeThreshold: 0.001,   // 🔥 紧急: 0.0005 → 0.001 (对齐 Onset Threshold)
  ...
  onset: {
    ...
    silenceThreshold: -60,       // 🔥 修复: -50 → -60 dB (对齐 minVolumeThreshold: 0.001)
  ...
  // ─────────────────────────────────────────────────────────────────────────
  version: '0.4.0'  // 与 package.json 保持一致
};
